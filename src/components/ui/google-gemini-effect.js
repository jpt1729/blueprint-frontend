...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("sticky top-80", className)}>
      <p className="text-lg md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-950 to-neutral-800">
        {title || "Blank."}
      </p>
      <p className="text-xs md:text-xl font-normal text-center text-neutral-900 mt-4 max-w-lg mx-auto">
        {description ||
          `Scroll this component and see the bottom SVG come to life wow this
        works!`}
      </p>
      <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
        <Link href ='/home' className="font-bold bg-black rounded-full md:px-4 md:py-2 px-2 py-1 md:mt-24 mt-8 z-30 md:text-base text-white text-xs  w-fit mx-auto ">
